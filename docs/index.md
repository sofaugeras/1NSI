...
!!! info "Entraînement :running: "
    ...
    - :hearts: [Codex](https://codex.forge.apps.education.fr/)
    - [e-nsi](https://e-nsi.forge.aeif.fr/init_python/){. target="_blank"}
    - [cercles informatiques](https://cscircles.cemc.mkduwaterloo.ca/fr/){. target="_blank"}
    - [France IOI](https://www.france-ioi.org/algo/chapters.php){. target="_blank"}
...
Archives : 
    ...
    - [Thème 4 : Architecture matérielle : Portes logiques](./T4_Architecture_materielle/4.1_Architecture_Von_Neumann/boole.md)
    ...
    - [Thème 5 : extremum et moyenne](./T5_Algorithmique/5.1_Extremums_et_moyennes/cours.md)
    - [Thème 5 : Complexité](./T5_Algorithmique/5.2_Complexite/cours.md) 
    - [Thème 3 : Type Construit : les tuples](./T3_Type_construit/3.2_Tuples/cours.md)  
    ...
    - [Thème 4 : Systèmes d'exploitation](./T4_Architecture_materielle/4.4_Decouverte_des_commandes_Linux/cours.md)
    ...
    - [TP Cyber](./T4_Architecture_materielle/4.2_Architecture_reseau/tpweb.md)
    - ✏️ DM Terminus
    - [Thème 3 : Type Construit : les dictionnaires](./T3_Type_construit/3.3_Dictionnaires/cours.md)
    - [Thème 6 : Traitement de données](./T6_Traitement_de_donnees/sommaire.md)
