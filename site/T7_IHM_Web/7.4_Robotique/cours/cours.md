...
![illustration](./data/illustration_iot.webp){: .center width=50%}
...
![illustration](./data/Les_Differents_aspect_Internet_des_objets_svg_1.png){: .center width=50%}
...
<iframe title="SNT : Les  objets connectés, des robots dans nos maisons ?" width="560" height="315" src="https://tube-sciences-technologies.apps.education.fr/videos/embed/1ubrzcjScxEwM6dZ5FfW4r" style="border: 0px;" allow="fullscreen" sandbox="allow-same-origin allow-scripts allow-popups allow-forms"></iframe>
