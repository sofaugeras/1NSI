# 4.2 Mini-projet : Créer un jeu multijoueur en réseau (2 clients)

**Durée : 4h**  
**Public : Première spécialité NSI**  
**Compétences :**  
...
- Utiliser des **sockets TCP** (module `socket` en Python).
...
| Critère | Points |
|--------|--------|
| Fonctionnement du jeu (sans bugs majeurs) | 10 |
| Qualité du protocole et des échanges | 4 |
| Clarté du code et des commentaires | 2 |
| Respect des consignes techniques | 2 |
| Originalité ou enrichissement | 2 |
...
- Interface graphique (ex : `tkinter`).
- Chat texte parallèle au jeu.
